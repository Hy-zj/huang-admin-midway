 ...
 * @LastEditTime: 2023-03-24 15:21:37
 */
...
export class LoginController {
    ...
    async login(@Body() loginBody: LoginBody): Promise<Result> {
        //返回token
        return Result.ok({
            token: await this.loginService.login(loginBody)
        })
    }
  ...
  */
    ...
    async logout(): Promise<Result> {
        ...
        this.loginService.logout(loginUser.uuid);
